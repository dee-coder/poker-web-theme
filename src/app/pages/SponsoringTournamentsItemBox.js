...
const SponsoringTournamentItemBox = (
  tournamentInfo,
  bettingInfo,
  playerInfo,
  sponsoringList,
            ...
            <Row>
              <Col lg={6}>
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    {tournamentInfo.allSponsors.length}
                  </Typography>{" "}
                </div>
              </Col>
              <Col lg={6}>
            ...
            <div className="d-flex align-items-center mb-9 bg-light-primary rounded p-5">
              ...
              <div className="d-flex flex-column flex-grow-1 mr-2">
                <span className="font-weight-normal text-dark-75  font-size-lg mb-1">
                  You are sponsoring this tournament and agreed to get{" "}
                  {tournamentInfo.bettingInfo.percent_to_each}% of total profit.
                </span>
...
export default SponsoringTournamentItemBox;
