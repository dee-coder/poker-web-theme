    ...
    if (props.match.params.id === undefined) {
      ...
      fetch(API.baseUrl + API.getPlayerProfile, {
        ...
        .then((response) => {
          ...
          setPlayerName(response.data.personalInfo[0].player_name);
          setProfileData(response.data.personalInfo[0]);
                ...
                <Col lg={4}>
                  <div className="d-flex inline align-items-center">
                    ...
                    <div style={{ marginLeft: "20px" }}>
                      ...
                      <Typography
                        variant="body2"
                        style={{ color: "#c4c4c4", marginTop: "10px" }}
                        gutterBottom
                      >
                        {ProfileData.player_network}{" "}
                      </Typography>
                    </div>
                  </div>
                </Col>
                                  ...
                                  <Row style={{ padding: "20px" }}>
                                    ...
                                    >
                                      <div style={{ textAlign: "left" }}>
                                        ...
                                        >
                                          {sponsorship._doc.number_of_sponsor}
                                        </Typography>{" "}
                                      </div>
                                    </div>
                                  </Row>
                                    ...
                                    <div>
                                      ...
                                      <Row style={{ marginTop: "20px" }}>
                                        ...
                                        <Col lg={2}>
                                          ...
                                          <br />
                                          <span className="text-muted font-weight-bold">
                                            {sponsorship._doc.percent_to_each} %
                                          </span>
                                        </Col>
                                        <Col lg={2}>
                                          <label>
                                          ...
                                          <br />
                                          <span className="text-muted font-weight-bold">
                                            {sponsorship._doc.total_parcent} %
                                          </span>
                                        </Col>
                                        <Col lg={2}>
                                          <label>
                                          ...
                                          <span className="text-muted font-weight-bold">
                                            {parseFloat(
                                              sponsorship._doc.amount_of_each
                                            )}
                                          </span>
                                        </Col>
                                      </Row>
